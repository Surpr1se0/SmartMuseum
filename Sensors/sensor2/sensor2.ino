...
void SendReadings() {
  ...
  Serial.println(temp);
  client.publish("room_b/temp/receive", String(temp).c_str());
  ...
  Serial.print("Smoke: ");
  Serial.println(smoke);
  client.publish("room_b/smoke/receive", String(smoke).c_str());

  // ALARM
  int alarm = getRandomMovement();
  Serial.print("Movement: ");
  Serial.println(alarm);
  client.publish("room_b/alarm/receive", String(alarm).c_str());
